...
<body>
	...
	function validate() {
		if (document.forms["deposit"]["accountNumber"].value == "") {
			alert("Please enter Account Number");
			document.forms["deposit"]["accountNumber"].focus();
			return false;
		}
		if (document.forms["deposit"]["amount"].value == "") {
			alert("Please enter Amount To Be Deposited");
			document.forms["deposit"]["amount"].focus();
			return false;
		}
	}
	</script>
<body>
	...
	<br>
	<br>
	<form:form modelAttribute="deposit" action="dpamount" name="deposit">
		<table
